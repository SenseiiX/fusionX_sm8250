...
curl -sSL "https://github.com/liyafe1997/SukiSU-Ultra/raw/4ff14cf0051d04209c4abd5027d99d8e7780ef5b/kernel/setup.sh" | bash -s f4863b20cc8dc0f8cc67418980f022e43014b598
(
  cd KernelSU/kernel
  echo "Adding more manager support..."
  sed -i '/{EXPECTED_SIZE_OTHER, EXPECTED_HASH_OTHER}, \/\/ Dynamic Sign/a\
